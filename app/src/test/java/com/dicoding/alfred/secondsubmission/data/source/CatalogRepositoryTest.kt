...
class CatalogRepositoryTest {
    ...
    private val listMovieResponse  =  Dummy.generateDataMovieDummyResponse()
    private val movieId  =  listMovieResponse[0].id
    private val listTvShowResponse  =  Dummy.generateDataTvShowDummyResponse()
    private val tvShowId  =  listTvShowResponse[0].id
    private val movieResponse  =  Dummy.generateDataMovieDummyResponse()[0]
    private val tvShowResponse  =  Dummy.generateDataTvShowDummyResponse()[0]
